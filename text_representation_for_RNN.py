...
def encoding(tokenizer, sent, max_length):
    '''Encoding the sentences and padding them accordingly'''
...
def create_matrix(sent):
    '''Create embedding matrix for the dataset and save it as pickle and h5py
    file, for better sharing'''
    tokenizer = Tokenizer()
    ...
    embedding_matrix = create_embedding_matrix(tokenizer, embedding_index, vocab_size, 300)
